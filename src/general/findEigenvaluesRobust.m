function [eigs, A] = findEigenvaluesRobust(p, v0)
    % Finds eigenvalues based on full 4x4 state matrix jacobian computation
    % assuming steady state flight at a set velocity, identifying the alpha
    % and gamma trim condition.
